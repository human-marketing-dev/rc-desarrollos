...
const es = {
  ...
  contact: {
    eyebrow: "Contacto",
    heading: "Solicita tu espacio en R.C. Desarrollos.",
    desc: "Déjanos tus datos y un asesor te contactará para conocer tus necesidades de espacio, energía y logística.",
    emailLabel: "Email",
...
const en: Content = {
  ...
  contact: {
    eyebrow: "Contact",
    heading: "Request your space at R.C. Desarrollos.",
    desc: "Leave your details and an advisor will contact you to understand your space, power, and logistics needs.",
    emailLabel: "Email",
